...
<html>
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath }/item/getIds.action" method="post">
            商品列表：
            <table width="100%" border=1>
                <tr>
                    <td>商品名称</td>
                ...
                <c:forEach items="${itemList }" var="item" varStatus="i">
                    <tr>
                        ...
                        <td><input type="text" name="itemList[${i.index}].createtime" value="<fmt:formatDate value="${item.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"></td>
